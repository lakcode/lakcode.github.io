...
function processLinks(data) {
	...
	data.links.forEach(function(link) {
		...
		if (link.attributes.strength) {
			link.weight = Number(link.attributes.strength);
			delete link.attributes.strength;
		}
...
function processNodeLinkRelationship(data,node) {
	...
	data.links.forEach(function(link) {
		...
		if (node.label == link.sourceLabel) {
			...
			//node.attributes.outDegree = link.outDegree;
		...
		if (node.label == link.targetLabel) {
			...
			//node.attributes.inDegree = link.inDegree;
